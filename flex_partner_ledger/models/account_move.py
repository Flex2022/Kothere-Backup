...
class AccountMove(models.Model):
    ...
    total_quantity = fields.Float(
        ...
        help="Total quantity of items in the move."
...
class AccountMoveLine(models.Model):
    ...
    total_quantity_line = fields.Float(
        string="Total Quantity",
        help="Total quantity of items in the move line."
    ...
    def _compute_total_quantity_line(self):
        for rec in self:
            rec.total_quantity_line = rec.move_id.total_quantity
        ...
        for column_group_key, group_options in report._split_options_per_column_group(options).items():
            ...
            queries.append(f'''
                SELECT
                    ...
                    account_move_line.total_quantity_line,
